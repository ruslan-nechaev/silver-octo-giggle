...
export function App(): JSX.Element {
  ...
  return (
    <div className="h-screen w-screen relative overflow-hidden bg-black rounded-none border-0 outline-none">
      ...
      <div className="absolute inset-x-0 bottom-2 z-40 flex flex-col items-center gap-3 px-4 transition-all duration-500 ease-out">
        <PearlButton
        ...
        />
        <div className="w-full max-w-[680px] mx-auto mt-1" style={{ paddingLeft: 16, paddingRight: 16 }}>
